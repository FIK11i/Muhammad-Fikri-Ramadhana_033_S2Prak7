// Implementasi Percobaan 2 untuk mengecek apakah notasi infix yang diinputkan benar atau tidak
#include <stdio.h>
#include <string.h>
#define MAXSTACK 100
...
main()
{
	...
	puts(" Mengubah Notasi Infix Menjadi Psotifix ");
